...
| |___| |___| |__| |_| / ___ \| |
 ...
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : CEEJAY
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mGithub  : https://github.com/Cee-Jay-Err0r/
...
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
os.system('xdg-open https://https://facebook.com/groups/636106957932486/')
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                Create()
                 ...
                 os.system('xdg-open https://facebook.com/groups/636106957932486/')
            elif xd in ['0','00']:
                exit(' Thanks for use 🥰 ')
            else:
...
def main_apv():
    ...
    try:
        ...
        tks = ('Hello%20CEEJAY%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)

    r1 = requests.get('https://github.com/Cee-Jay-Err0r/CJ/blob/main/Vee').text
    ...
    if key1 in r1:
        ...
        linex()
        print (' \033[1;37mThis Tool is FREE So Need Get Approval') 
       
        print('FREE TOOL');linex()
        input(' \033[1;37mPress Enter To send key Admin')
        tks = ('Hello%20CJ%20Owner%20CEEJAY%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+2348026659495?text='+tks)
        main_apv()
main_apv()
